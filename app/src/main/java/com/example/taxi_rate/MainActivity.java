...
public class MainActivity extends AppCompatActivity {
    ...
    public void cost(View view){
        EditText ed1 = findViewById(R.id.start);
        EditText ed4 = findViewById(R.id.meter);
        TextView tv1 = findViewById(R.id.textView6);
        EditText ed2 = findViewById(R.id.setmoney);
        EditText ed3 = findViewById(R.id.setmeter);
